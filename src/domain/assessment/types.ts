...
export type Question = {
  ...
  readonly tags?: readonly string[]; readonly version: number; readonly status: QuestionStatus; readonly reviewStatus: ReviewStatus;
};
type AssessmentSetBase = {
  readonly schemaVersion: '1.0'; readonly id: string; readonly trackId: TrackId; readonly title: string;
  readonly questionIds: readonly string[]; readonly masteryThresholdPercent: 80; readonly attemptPolicy: 'unlimited';
  readonly version: number; readonly status: QuestionStatus; readonly reviewStatus: ReviewStatus;
};
export type TopicQuiz = AssessmentSetBase & { readonly kind: 'topic-quiz'; readonly moduleId?: string };
